   ...
   new_G=zeros(nNodes,1);
    ...
    switch(Takens.Parcell)
        ...
        case 6
            ...
            LBOUND=[ Takens.alphabound(1)*ones(1,max_Group) Takens.betabound(1)*ones(1,max_Group) Takens.Gbound(1) ];
            UBOUND=[ Takens.alphabound(2)*ones(1,max_Group) Takens.betabound(2)*ones(1,max_Group) Takens.Gbound(2) ];
        ...
        case 7
            ...
            LBOUND=[ Takens.alphabound(1)*ones(1,max_Group) Takens.betabound(1)*ones(1,max_Group) Takens.Gbound(1)*ones(1,max_Group) ];
            UBOUND=[ Takens.alphabound(2)*ones(1,max_Group) Takens.betabound(2)*ones(1,max_Group) Takens.Gbound(2)*ones(1,max_Group) ];
